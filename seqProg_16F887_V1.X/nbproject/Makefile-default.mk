...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/seqProg_16F887_V1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=atuadores.c delay.c dispLCD4vias.c eeprom.c fifo.c serialIO.c teclado.c timer1.c main.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/atuadores.p1 ${OBJECTDIR}/delay.p1 ${OBJECTDIR}/dispLCD4vias.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/fifo.p1 ${OBJECTDIR}/serialIO.p1 ${OBJECTDIR}/teclado.p1 ${OBJECTDIR}/timer1.p1 ${OBJECTDIR}/main.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/atuadores.p1.d ${OBJECTDIR}/delay.p1.d ${OBJECTDIR}/dispLCD4vias.p1.d ${OBJECTDIR}/eeprom.p1.d ${OBJECTDIR}/fifo.p1.d ${OBJECTDIR}/serialIO.p1.d ${OBJECTDIR}/teclado.p1.d ${OBJECTDIR}/timer1.p1.d ${OBJECTDIR}/main.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/atuadores.p1 ${OBJECTDIR}/delay.p1 ${OBJECTDIR}/dispLCD4vias.p1 ${OBJECTDIR}/eeprom.p1 ${OBJECTDIR}/fifo.p1 ${OBJECTDIR}/serialIO.p1 ${OBJECTDIR}/teclado.p1 ${OBJECTDIR}/timer1.p1 ${OBJECTDIR}/main.p1

# Source Files
SOURCEFILES=atuadores.c delay.c dispLCD4vias.c eeprom.c fifo.c serialIO.c teclado.c timer1.c main.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/seqProg_16F887_V1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/seqProg_16F887_V1.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/seqProg_16F887_V1.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/seqProg_16F887_V1.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/seqProg_16F887_V1.X.${IMAGE_TYPE}.hex 
