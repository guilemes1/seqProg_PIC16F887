...
//                            receita.formatar();                          //Formata a memoria - Trava sempre que executado no simulador
//                            dispLCD_clr();
//                            for(char i = 0; i <= 3; i++)
//                            {
//                                for(char j = 0; j <= 19; j++)
...
//                            break;   
            ...
            case TELA_INSERIR_PASSOS:
             ...
             case TELA_EXECUTANDO_PASSOS:
                            ...
                            meAtuadores = ME_ATUADORES_START;                  //MOMENTO DE INICIO DA EXECUÇÃO
                            break;
...
//                            break;
        ...
        switch(meAtuadores)
        {
            ...
            case 1:
                            resetIndicePassos();   //indice_passos = 2
                            resetContCiclos();     //cont_ciclos = 0               
                            meAtuadores = 2;
                            break;

            case 2:
                            auxPasso = fifo_lerPos(getIndicePassos());        //auxPasso = fila[2] - Passo
            ...
            case 3:
                            if(auxPasso & 0x80)   //Se o passo for um tempo
                            {
                                setT1( (unsigned long int)(auxPasso & 0x7F) * 1000 );   //ex: auxPasso = 83(3s), então 0x83 & 0x7F = 0x03, logo 0x03 *1000 = 1000 --> setT1(3000)
                                meAtuadores = 4;
                            }
                            else    //Se o passo for um atuador(caracter)
                            {
